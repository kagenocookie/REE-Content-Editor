# REE Content Editor
Desktop tool for editing and partial patching the files of all RE ENGINE titles, the next evolution of [DD2 ingame Content Editor](https://github.com/kagenocookie/dd2-content-editor). The project is based on [REE-Lib](https://github.com/kagenocookie/RE-Engine-Lib) for file editing and an ImGui.NET-based UI with full graphics capabilities. It can provide most functionality needed for mod development.
