...
public sealed class UVSequenceFileEditor : FileEditor, IWorkspaceContainer, IDisposable
{
    ...
    protected override void DrawFileContents()
    {
        ...
        ImGui.SameLine();
        if (ImGui.Button($"{AppIcons.SI_GenericAdd} New Sequence")) {
        ...
        ImGui.PopStyleColor();
        ImguiHelpers.Tooltip("Delete sequence");
        ImGui.SameLine();
        ...
        if (sequence != null) {
            ...
            if (ImGui.BeginTabItem("Grid Arrangement")) {
        ...
        if (sequence != null) {
            ...
            ImGui.SeparatorText("Sequence Player");
